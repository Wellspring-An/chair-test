<template>
  <div class="ai-chat-page">
    ...
    <div class="input-area">
      ...
      <div class="field">
        <label>系统提示</label>
        <input v-model="systemMessage" placeholder="请输入系统提示词" />
      </div>
      <div class="btn-group">
...
import { aiChat, aiChatStream } from "@/api/appController";

// 基础配置
const userMessage = ref("你好，请介绍一下你自己");
const systemMessage = ref("你是一个有帮助的AI助手");
const output = ref("");
