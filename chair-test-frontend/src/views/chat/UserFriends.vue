  ...
  <main class="chat-window">
    <div class="divider-demo">
        ...
        <a-collapse-item v-for="item in myNotFriends" :key="item.id">
          <template #header>
            ...
            <a-tooltip content="右键进行操作" position="top">
              <div @contextmenu.prevent="handleContextMenu($event, item)" style="display:flex;align-items:center;gap:80px;">
                <img
      ...
      <div
        ...
        @click.stop
      >
        <div class="menu-item" @click="agreeFriend(currentOperateRecord!)">通过</div>
        <div class="menu-item" @click="refuseFriend(currentOperateRecord!)">拒绝</div>
        <div class="menu-item" @click="deleteFriend(currentOperateRecord!)">删除</div>
        <div class="menu-item" @click="deFriend(currentOperateRecord!)">拉黑</div>
      </div>
    </div>
  </main>
  <ChatFooter />
