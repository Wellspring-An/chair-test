...
import com.chair.chairdada.model.dto.userAnswer.UserAnswerAddRequest;
import com.chair.chairdada.model.dto.userAnswer.UserAnswerEditRequest;
import com.chair.chairdada.model.dto.userAnswer.UserAnswerQueryRequest;
import com.chair.chairdada.model.dto.userAnswer.UserAnswerUpdateRequest;
...
import com.chair.chairdada.scoring.ScoringStrategyExecutor;
...
public class UserAnswerController {
    ...
    public BaseResponse<Long> addUserAnswer(@RequestBody UserAnswerAddRequest userAnswerAddRequest, HttpServletRequest request) {
        ...
        if (!Objects.equals(ReviewStatusEnum.PASS, ReviewStatusEnum.getEnumByValue(app.getReviewStatus()))) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR, "应用未通过审核, 无法答题");
        }
//        if (app.getScoringStrategy().equals(AppScoringStrategyEnum.Ai)) {
//
//        }
        // 填充默认值
