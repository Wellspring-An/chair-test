...
public class QuestionController {
    ...
    private static final String GENERATE_QUESTION_SYSTEM_MESSAGE = "你是一位严谨的出题专家，我会给你如下信息：\n" +
            ...
            "```\n" +
            "[{\"options\":[{\"value\":\"选项内容\",\"key\":\"A\",\"score\":\"1\"},{\"value\":\"选项内容\",\"key\":\"B\"},\"score\":\"0\"],\"title\":\"题目标题\"}]\n" +
            "```\n" +
            "title 是题目，options 是选项，每个选项的 key 按照英文字母序（比如 A、B、C、D）以此类推，value 是选项内容，value不要含有答案或问题，score 是得分，如果该选项是正确的则score是1，反之则是0，score、value和key中不能是空的，题目和选项数严格按照我给的数字生成\n" +
